# Moxy Sensor Python script to read from device and decode the data

This guide has been prepared to enable the Python developers to connect to the device then, pull the data and decode it.
